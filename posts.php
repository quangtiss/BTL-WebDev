                                ...
                                <div class="col-xl-3 col-md-6 col-sm-12 mb-3">
                                    <div class="card h-100" style="height: 200px">
                                        <div class="product-img"
                                            style="background-image: url('<?php echo $row['image'] ?>');background-size:100% 100%; padding-top: 50%;">
                                        </div>
                            ...
                            <nav class="mt-3">
                                <ul class="pagination pagination-lg d-flex">
                                    ...
                                    if ($currentPage > 1 && $totalPage > 1) {
                                        ?>
                                        <li class="page-item">
                                            <a href="<?php echo $rootPath ?>/posts.php?page=<?php echo ($currentPage - 1); ?>"
                                                class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
                                                data-remote="true">&lsaquo; Prev</a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    for ($i = 1; $i <= $totalPage; $i++) {
                                        if ($i == $currentPage) {
                                            ...
                                            <li class="page-item active">
                                                <span rel="prev"
                                                    class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-light"
                                                    data-remote="true"><?php echo $i ?></span>
                                            </li>
                                            <?php
                                        } else {
                                            ?>
                                            <li class="page-item">
                                                <a data-remote="true"
                                                    class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
                                                    href="<?php echo $rootPath ?>/posts.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                            </li>
                                            <?php
                                        }
                                    }
                                    ...
                                    if ($currentPage < $totalPage && $totalPage > 1) {
                                        ...
                                        <li class="page-item">
                                            <a href="<?php echo $rootPath; ?>/posts.php?page=<?php echo ($currentPage + 1) ?>"
                                                class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
                                                data-remote="true">Next &rsaquo;</a>
                                        </li>
                                        <?php
                                    }
                                    ?>
