    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                <label for="email" class="form-label text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4"
                    style="color:#002A54">Lấy lại mật khẩu</label>
                ...
                <br>
                <div class="row">
                    <div class="alert alert-success text-center">Vui lòng nhập vào Email tài khoản của bạn.<br>Chúng tôi
                        có thể giúp bạn lấy lại mật khẩu.</div>
                </div>
            </div>
            <div
                class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center justify-content-center order-1 order-lg-2">
                <img class="img-fluid rounded w-50" alt="Login image" src="../public/img/login2.png" />
            </div>
        </div>
    </div>
