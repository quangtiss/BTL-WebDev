                ...
                <div class="container pb-5">
                    <div class="row">
                        <div class="col-lg-5 mt-5">
                            <div class="card mb-3">
                                <img class="card-img rounded img-fluid" id="product-detail" alt="bla"
                                    src="./public/img/products/<?php echo $row["images"]; ?>">
                            </div>
                        </div>
                        <!-- col end -->
                        <div class="col-lg-7 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h1 class="h2" style="color:#002A54"><?php echo $row["name"]; ?> <span
                                            class="text-secondary">#<?php echo $row["product_id"]; ?></span></h1>
                                    ...
                                    <form action="process_cart.php" accept-charset="UTF-8" method="get">
                                                ...
                                                <ul class="list-inline pb-3 equal-width">
                                                    ...
                                                    <li class="list-inline-item col-3">
                                                        <input type="number" class="form-control" name="quantity"
                                                            id="quantityInput" value=1 min=1 max="<?= $row['quantity'] ?>">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="row pb-3 d-flex justify-content-end">
                                            <div class="col-xl-4 col-md-6 col-sm-12">
                                                ...
                                                <button onclick="addCartItem(<?= $row['product_id'] ?>)" class="w-100 btn btn-warning btn-lg  <?php if ($row["quantity"] <= 0)
                                                      echo 'disabled' ?>"><i class="fa-solid fa-cart-plus"></i> Thêm
                                                        vào giỏ</button>
                                                </div>
                                            </div>
                                        </form>
            ...
            <div class="row">
                ...
                <div class="ps-3 pe-3 pt-3 pb-3">
                    <button type="button" class="btn btn-primary <?php if (!isset($_SESSION['email_user']))
                        echo 'disabled' ?>" data-bs-toggle="modal" data-bs-target="#postReview"><i
                                class="fa-sharp fa-solid fa-circle-star"></i>
